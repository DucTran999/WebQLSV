			 ...
			 <div class="panel-body">
                <form method="post">
                    <div class="form-group">
                      ...
                      <input required="true" type="text" class="form-control" id="id_lop" name="id_lop" placeholder="Lớp" value="<?=$s_id_lop?>">
                    </div>
                    <div class="form-group">
                      <label for="ten"> Họ và Tên</label>
                      <input type="text" class="form-control" id="name" name="name" placeholder=" Tên sinh viên " value="<?=$s_name?>">
                    </div>
                    <div class="form-group">
                      <label for="msv"> Mã sinh viên</label>
                      <input type="text" class="form-control" id="msv" name="msv" placeholder=" Mã sinh viên" value="<?=$s_msv?>">
                    </div>
                    <div class="form-group">
