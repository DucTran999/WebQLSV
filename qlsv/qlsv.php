...
<body>
 ...
 <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li><a href="admin.php.php"><em class="fa fa-dashboard">&nbsp;</em> Thông báo </a></li>
     ...
     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><b>QUẢN LÝ THÔNG TIN SINH VIÊN</b></h1>
            </div>
        </div>
            <div class="container">
                <form method="get">
                ...
                <button class="btn btn-success" onclick="window.open('addsv.php', '_self')">Thêm mới</button>
...
{
    $sql = 'SELECT * FROM ttsv WHERE hoten LIKE "%'.$_GET['s'].'%"';
} 
else 
{
    $sql = 'SELECT * FROM ttsv';
}
...
foreach ($studentList as $std) {
    echo '<tr>
            ...
            <td>'.$std['que'].'</td>
            <td>'.$std['MSV'].'</td>
            <td><button class="btn btn-warning" onclick=\'window.open("edit_sv.php.?ID='.$std['ID'].'","_self")\'>Sửa</button></td>
