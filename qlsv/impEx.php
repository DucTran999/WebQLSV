...
if(isset($_POST['btnGui']))
{
    ...
    $objReader -> setLoadSheetsOnly('AT01');
    ...
    for($row = 2; $row <= $highestRow; $row++ )
    {
        ...
        $sql = " INSERT INTO diem (id_lop,name,msv,cc,btl,ktr,ck,TB) VALUES ($id_lop,'$name','$msv',$cc,$btl,$ktr,$ck,$TB)";
     ...
     <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            ...
            <div class="container">
                ...
                <button class ="btn btn-info" type="submit"><input type="file" name="file"></button>
                <button type="submit" class ="btn btn-info" name ="btnGui">Thêm Excel</button>        
                </form>
